    ...
    <section className="bg-bg relative overflow-hidden px-6 py-14 md:py-24" style={{ isolation: "isolate" }}>
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted text-base leading-relaxed max-w-md mb-8 animate-fade-up" style={{ animationDelay: "160ms" }}>
          ...
          <div className="flex flex-row gap-3 flex-wrap animate-fade-up" style={{ animationDelay: "240ms" }}>
            <a
              href="#projects"
        ...
        <div className="flex flex-col gap-3 items-start md:items-end relative z-0">
          <div className="bg-terra text-white px-5 py-4 w-56 animate-fade-up hover:-translate-y-0.5 transition-transform duration-200" style={{ animationDelay: "120ms" }}>
          ...
          <div className="bg-surface border border-soft px-5 py-4 w-56 animate-fade-up hover:-translate-y-0.5 transition-transform duration-200" style={{ animationDelay: "200ms" }}>
          ...
          <div className="bg-surface border border-soft px-5 py-4 w-56 animate-fade-up hover:-translate-y-0.5 transition-transform duration-200" style={{ animationDelay: "280ms" }}>
